...
def roll_dice(num_rolls, dice=six_sided):
    ...
    if has1 == True:
        ...
        return total
    # END PROBLEM 1 
    #12/28 11:50 finished and passed, be careful of the infinite while loop, i should increase by 1 in every loop

def boar_brawl(player_score, opponent_score):
    """Return the points scored when the current player rolls 0 dice according to Boar Brawl.

    player_score:     The total score of the current player. <100
    opponent_score:   The total score of the other player. < 100
    ...
    """
       backup_opponent_score = opponent_score
    countdigit = 1
    ...
    while (countdigit > 1):
        backup_opponent_score = backup_opponent_score // 10
        countdigit -= 1
    tensDigit = 0
    if opponent_score < 10:
        tensDigit = opponent_score // 10
    else:
        tensDigit = backup_opponent_score
    """    
...
def sus_points(score):
    ...
    if num_factors(score) == 3 or num_factors(score) == 4:
        while is_prime(sus_points) == False:
            sus_points += 1
        return sus_points
    else:
        return score
...
def sus_update(num_rolls, player_score, opponent_score, dice=six_sided):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    return sus_points(simple_update(num_rolls, player_score, opponent_score, dice)) # 不能写默认值，要写准确的dice
...
def always_roll(n):
    ...
    # BEGIN PROBLEM 6
    "*** YOUR CODE HERE ***"
    def num_always_roll(score0, score1):
        return n
    return num_always_roll
    # END PROBLEM 6
...
def make_averaged(original_function, times_called=1000):
    ...
    def averaged_dice(*args):
        ...
        while i < times_called:
            total_time = original_function(*args) + total_time 
            i += 1
        return total_time/ times_called 
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    Suss Fuss rules."""
    # BEGIN PROBLEM 11
    num = sus_update(0, score, opponent_score) - score
    #num = sus_points(score + boar_brawl(score, opponent_score)) - score ## alt + <- 
    if num >= threshold:
        return 0
    return num_rolls  # Remove this line once implemented.
    # END PROBLEM 11
